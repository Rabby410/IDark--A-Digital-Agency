      ...
      <div className="bg-white py-10">
        <div className="container mx-auto justify-center items-center">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 py-10">
            <div>
              <img src="/images/services/service-01.png" alt="service-idark" className="px-5" />
            </div>
            <div className="px-5">
              ...
              <ul className="para list-disc">
                <li className="my-3 mx-5">Yet this above sewed flirted opened ouch</li>
                <li className="my-3 mx-5">Goldfinch realistic sporadic ingenuous</li>
                <li className="my-3 mx-5">Abominable this abidin far successfully then like piquan</li>
                <li className="my-3 mx-5">Risus commodo viverra</li>
                <li className="my-3 mx-5">Lorem ipsum dolor sit amet, consectetur adipiscing</li>
              </ul>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 my-10">
            ...
            <div className="px-5"><VideoPopup /></div>
          </div>
        </div>
      </div>
    </>
