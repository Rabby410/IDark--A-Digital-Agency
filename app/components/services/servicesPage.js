      ...
      <div>
        <div className="bg-gray-100 py-10">
          <div className="container mx-auto justify-center items-center">
            <h1 className="title text-center">Digital Marketing</h1>
        ...
        <div className="bg-white py-10">
          <div className="container mx-auto justify-center items-center">
            <h1 className="title text-center">Strategy</h1>
            <p className="para text-center mt-5">
              There are many variations of passages of Lorem Ipsum available,
              but the majority have suffered alteration.
            </p>
        ...
        <div className="bg-gray-100 py-10">
          <div className="container mx-auto justify-center items-center">
            <h1 className="title text-center">Creative Agency</h1>
            <p className="para text-center mt-5">
            There are many variations of passages of Lorem Ipsum available,
            but the majority have suffered alteration.
            </p>
        ...
        <div className="bg-white py-10">
          <div className="container mx-auto justify-center items-center">
            <h1 className="title text-center">Development</h1>
            <p className="para text-center mt-5">
            There are many variations of passages of Lorem Ipsum available,
            but the majority have suffered alteration.
            </p>
